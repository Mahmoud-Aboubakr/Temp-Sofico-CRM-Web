...
{
    public class SalesBranchControlModel
    {
        ...
        public IEnumerable<SalesBranchControlDetailModel> SalesControlDetails { get; set; } = new List<SalesBranchControlDetailModel>();

    }

    public class SalesBranchControlDetailModel
    {
