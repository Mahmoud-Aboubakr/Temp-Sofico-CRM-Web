...
{
    public class SalesSupervisorControlModel
    {
        ...
        public IEnumerable<SalesSupervisorControlDetailModel> SalesControlDetails { get; set; } = new List<SalesSupervisorControlDetailModel>();

    }

    public class SalesSupervisorControlDetailModel
    {
