...
namespace SofiForce.Worker
{
    ...
    public class OrderService: IOrderService
    {
        ...
        public OrderService(ISalesOrderManager salesOrderManager)
        {
            ...
            //var loginDTO = new AuthenticationModel() { Client = "mobile", Password = "11111", UserName = "dev" };
            //var json = JsonConvert.SerializeObject(loginDTO);
            //var data = new StringContent(json, Encoding.UTF8, "application/json");

            //var response = client.PostAsync(Auth, data).Result;
            //var result = response.Content.ReadAsStringAsync().Result;

            //var obj =JsonConvert.DeserializeObject<ResponseModel<UserModel>>(result);
            //client.DefaultRequestHeaders.Authorization= new AuthenticationHeaderValue("Bearer", obj.Data.Token);
