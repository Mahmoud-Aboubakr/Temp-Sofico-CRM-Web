...
{
	public partial class DAOClientGroupSub : zSofiForceConn_BaseData
	{
		...
		public DAOClientGroupSub()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table ClientGroupSub based on the primary key(s)
		///</Summary>
		///<returns>
		///DAOClientGroupSub
		///</returns>
		...
		///</parameters>
		public static DAOClientGroupSub SelectOne(Int32? clientGroupSubId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_SelectOne;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("ClientGroupSub");
			SqlDataAdapter sqlAdapter = new SqlDataAdapter(command);
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)clientGroupSubId?? (object)DBNull.Value));

				staticConnection.Open();
				sqlAdapter.Fill(dt);

				DAOClientGroupSub retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOClientGroupSub();
					...
					retObj._clientGroupSubCode					 = Convert.IsDBNull(dt.Rows[0]["ClientGroupSubCode"]) ? null : (string)dt.Rows[0]["ClientGroupSubCode"];
					retObj._clientGroupSubNameEn					 = Convert.IsDBNull(dt.Rows[0]["ClientGroupSubNameEn"]) ? null : (string)dt.Rows[0]["ClientGroupSubNameEn"];
					retObj._clientGroupSubNameAr					 = Convert.IsDBNull(dt.Rows[0]["ClientGroupSubNameAr"]) ? null : (string)dt.Rows[0]["ClientGroupSubNameAr"];
		...
		///this method allows the object to delete itself from the table ClientGroupSub based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_DeleteOne;
			command.CommandType = CommandType.Text;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubId?? (object)DBNull.Value));
		...
		///This method returns all data rows in the table ClientGroupSub based on a foreign key
		///</Summary>
		///<returns>
		///IList-DAOClientGroupSub.
		///</returns>
		///<parameters>
		///Int32? clientGroupId
		///</parameters>
		public static IList<DAOClientGroupSub> SelectAllByClientGroupId(Int32? clientGroupId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_SelectAllByClientGroupId;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAOClientGroupSub> objList = new List<DAOClientGroupSub>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOClientGroupSub retObj = new DAOClientGroupSub();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_SelectAllByClientGroupIdCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method deletes all rows in the table ClientGroupSub with a given foreign key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_DeleteAllByClientGroupId;
			command.CommandType = CommandType.Text;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table ClientGroupSub
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubId", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _clientGroupSubId));
				...
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubNameEn", SqlDbType.NVarChar, 100, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubNameAr", SqlDbType.NVarChar, 100, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubNameAr?? (object)DBNull.Value));
				...
				_clientGroupSubCode					 = Convert.IsDBNull(command.Parameters["@ClientGroupSubCode"].Value) ? null : (string)command.Parameters["@ClientGroupSubCode"].Value;
				_clientGroupSubNameEn					 = Convert.IsDBNull(command.Parameters["@ClientGroupSubNameEn"].Value) ? null : (string)command.Parameters["@ClientGroupSubNameEn"].Value;
				_clientGroupSubNameAr					 = Convert.IsDBNull(command.Parameters["@ClientGroupSubNameAr"].Value) ? null : (string)command.Parameters["@ClientGroupSubNameAr"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table ClientGroupSub
		///</Summary>
		///<returns>
		///IList-DAOClientGroupSub.
		///</returns>
		...
		///
		///</parameters>
		public static IList<DAOClientGroupSub> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiClientGroupSub
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprClientGroupSub_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api ClientGroupSub
		///</Summary>
		///<returns>
		///IList-DAOClientGroupSub.
		///</returns>
		...
		///</parameters>
		public static IList<DAOClientGroupSub> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprClientGroupSub_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprClientGroupSub_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table ClientGroupSub based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClientGroupSub_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubId", SqlDbType.Int, 4, ParameterDirection.InputOutput, false, 10, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupId", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_clientGroupId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubNameEn", SqlDbType.NVarChar, 100, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@ClientGroupSubNameAr", SqlDbType.NVarChar, 100, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_clientGroupSubNameAr?? (object)DBNull.Value));
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprClientGroupSub_SelectOne = @"
			...
			,[EBy]
			,[EDate]
			FROM [dbo].[ClientGroupSub]
			WHERE 
			[ClientGroupSubId] = @ClientGroupSubId
			";

		internal static string ctprClientGroupSub_DeleteOne = @"
			-- Delete a row based on the primary key(s)
			-- delete all matching from the table
			DELETE [dbo].[ClientGroupSub]
			WHERE 
			[ClientGroupSubId] = @ClientGroupSubId
			";

		internal static string ctprClientGroupSub_SelectAllByClientGroupId = @"
		...
		internal static string ctprClientGroupSub_SelectAllByClientGroupIdCount = @"
		...
		internal static string ctprClientGroupSub_DeleteAllByClientGroupId = @"
		...
		internal static string ctprClientGroupSub_InsertOne = @"
			-- Insert a new row
			-- inserts a new row into the table
			INSERT [dbo].[ClientGroupSub]
			(
			[ClientGroupId]
			,[ClientGroupSubCode]
			,[ClientGroupSubNameEn]
			...
			,@ClientGroupSubCode = [ClientGroupSubCode]
			,@ClientGroupSubNameEn = [ClientGroupSubNameEn]
			,@ClientGroupSubNameAr = [ClientGroupSubNameAr]
			,@IsActive = [IsActive]
			,@CanEdit = [CanEdit]
			,@CanDelete = [CanDelete]
			,@Icon = [Icon]
			...
			FROM [dbo].[ClientGroupSub]
			WHERE 
			[ClientGroupSubId] = SCOPE_IDENTITY()
			";

		internal static string ctprClientGroupSub_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[ClientGroupSubId]
		...
		internal static string ctprClientGroupSub_SelectAllCount = @"
		...
		internal static string ctprClientGroupSub_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprClientGroupSub_SelectAllByCriteria = @"
		...
		internal static string ctprClientGroupSub_SelectAllByCriteriaCount = @"
		...
		internal static string ctprClientGroupSub_UpdateOne = @"
			-- Update one row based on the primary key(s)
			-- updates a row in the table based on the primary key
			
			UPDATE [dbo].[ClientGroupSub]
			SET
			[ClientGroupId] = @ClientGroupId
			,[ClientGroupSubCode] = @ClientGroupSubCode
			,[ClientGroupSubNameEn] = @ClientGroupSubNameEn
