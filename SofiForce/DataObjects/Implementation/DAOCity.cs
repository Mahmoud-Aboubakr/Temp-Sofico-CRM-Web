...
{
	public partial class DAOCity : zSofiForceConn_BaseData
	{
		...
		///This method returns one row from the table City based on the primary key(s)
		///</Summary>
		///<returns>
		///DAOCity
		///</returns>
		...
		///Int32? cityId
		///</parameters>
		public static DAOCity SelectOne(Int32? cityId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_SelectOne;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CityId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)cityId?? (object)DBNull.Value));
				...
				if(dt.Rows.Count > 0)
				{
					...
					retObj._cityNameAr					 = Convert.IsDBNull(dt.Rows[0]["CityNameAr"]) ? null : (string)dt.Rows[0]["CityNameAr"];
					retObj._cityNameEn					 = Convert.IsDBNull(dt.Rows[0]["CityNameEn"]) ? null : (string)dt.Rows[0]["CityNameEn"];
					retObj._cityCode					 = Convert.IsDBNull(dt.Rows[0]["CityCode"]) ? null : (string)dt.Rows[0]["CityCode"];
		...
		///this method allows the object to delete itself from the table City based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_DeleteOne;
			command.CommandType = CommandType.Text;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CityId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)_cityId?? (object)DBNull.Value));
		...
		///This method returns all data rows in the table City based on a foreign key
		///</Summary>
		///<returns>
		///IList-DAOCity.
		///</returns>
		...
		///Int32? governerateId
		///</parameters>
		public static IList<DAOCity> SelectAllByGovernerateId(Int32? governerateId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_SelectAllByGovernerateId;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAOCity> objList = new List<DAOCity>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOCity retObj = new DAOCity();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_SelectAllByGovernerateIdCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method deletes all rows in the table City with a given foreign key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_DeleteAllByGovernerateId;
			command.CommandType = CommandType.Text;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table City
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CityId", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _cityId));
				...
				command.Parameters.Add(CtSqlParameter.Get("@CityNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_cityNameAr?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@CityNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_cityNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@CityCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_cityCode?? (object)DBNull.Value));
				...
				_cityNameAr					 = Convert.IsDBNull(command.Parameters["@CityNameAr"].Value) ? null : (string)command.Parameters["@CityNameAr"].Value;
				_cityNameEn					 = Convert.IsDBNull(command.Parameters["@CityNameEn"].Value) ? null : (string)command.Parameters["@CityNameEn"].Value;
				_cityCode					 = Convert.IsDBNull(command.Parameters["@CityCode"].Value) ? null : (string)command.Parameters["@CityCode"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table City
		///</Summary>
		///<returns>
		///IList-DAOCity.
		///</returns>
		...
		///
		///</parameters>
		public static IList<DAOCity> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiCity
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprCity_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api City
		///</Summary>
		///<returns>
		///IList-DAOCity.
		///</returns>
		...
		///</parameters>
		public static IList<DAOCity> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprCity_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprCity_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table City based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprCity_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CityId", SqlDbType.Int, 4, ParameterDirection.InputOutput, false, 10, 0, "", DataRowVersion.Proposed, (object)_cityId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateId", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_governerateId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@CityNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_cityNameAr?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@CityNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_cityNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@CityCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_cityCode?? (object)DBNull.Value));
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprCity_SelectOne = @"
		...
		internal static string ctprCity_DeleteOne = @"
		...
		internal static string ctprCity_SelectAllByGovernerateId = @"
		...
		internal static string ctprCity_SelectAllByGovernerateIdCount = @"
		...
		internal static string ctprCity_DeleteAllByGovernerateId = @"
		...
		internal static string ctprCity_InsertOne = @"
			-- Insert a new row
		...
		internal static string ctprCity_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[CityId]
		...
		internal static string ctprCity_SelectAllCount = @"
		...
		internal static string ctprCity_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprCity_SelectAllByCriteria = @"
		...
		internal static string ctprCity_SelectAllByCriteriaCount = @"
		...
		internal static string ctprCity_UpdateOne = @"
