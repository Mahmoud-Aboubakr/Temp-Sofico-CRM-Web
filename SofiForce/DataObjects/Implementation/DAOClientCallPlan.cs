...
{
	public partial class DAOClientCallPlan : zSofiForceConn_BaseData
	{
		...
		public DAOClientCallPlan()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table Client_CallPlan based on the primary key(s)
		///</Summary>
		///<returns>
		///DAOClientCallPlan
		///</returns>
		...
		///Int32? calPlanId
		///</parameters>
		public static DAOClientCallPlan SelectOne(Int32? calPlanId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_SelectOne;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("Client_CallPlan");
			SqlDataAdapter sqlAdapter = new SqlDataAdapter(command);
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CalPlanId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)calPlanId?? (object)DBNull.Value));

				staticConnection.Open();
				sqlAdapter.Fill(dt);

				DAOClientCallPlan retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOClientCallPlan();
					retObj._calPlanId					 = Convert.IsDBNull(dt.Rows[0]["CalPlanId"]) ? (Int32?)null : (Int32?)dt.Rows[0]["CalPlanId"];
		...
		///this method allows the object to delete itself from the table Client_CallPlan based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_DeleteOne;
			command.CommandType = CommandType.Text;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CalPlanId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)_calPlanId?? (object)DBNull.Value));
		...
		///This method returns all data rows in the table Client_CallPlan based on a foreign key
		///</Summary>
		///<returns>
		///IList-DAOClientCallPlan.
		///</returns>
		///<parameters>
		///Int32? clientId
		///</parameters>
		public static IList<DAOClientCallPlan> SelectAllByClientId(Int32? clientId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_SelectAllByClientId;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAOClientCallPlan> objList = new List<DAOClientCallPlan>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOClientCallPlan retObj = new DAOClientCallPlan();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_SelectAllByClientIdCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method deletes all rows in the table Client_CallPlan with a given foreign key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_DeleteAllByClientId;
			command.CommandType = CommandType.Text;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table Client_CallPlan
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CalPlanId", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _calPlanId));
				...
				_calPlanId					 = Convert.IsDBNull(command.Parameters["@CalPlanId"].Value) ? (Int32?)null : (Int32?)command.Parameters["@CalPlanId"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table Client_CallPlan
		///</Summary>
		///<returns>
		///IList-DAOClientCallPlan.
		///</returns>
		...
		///
		///</parameters>
		public static IList<DAOClientCallPlan> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiClient_CallPlan
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprClient_CallPlan_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api Client_CallPlan
		///</Summary>
		///<returns>
		///IList-DAOClientCallPlan.
		///</returns>
		...
		///</parameters>
		public static IList<DAOClientCallPlan> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprClient_CallPlan_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprClient_CallPlan_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table Client_CallPlan based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprClient_CallPlan_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@CalPlanId", SqlDbType.Int, 4, ParameterDirection.InputOutput, false, 10, 0, "", DataRowVersion.Proposed, (object)_calPlanId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@ClientId", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_clientId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@Day1", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_day1?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@Day2", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_day2?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@Day3", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_day3?? (object)DBNull.Value));
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprClient_CallPlan_SelectOne = @"
			...
			,[Day6]
			,[Day7]
			FROM [dbo].[Client_CallPlan]
			WHERE 
			[CalPlanId] = @CalPlanId
			";

		internal static string ctprClient_CallPlan_DeleteOne = @"
			-- Delete a row based on the primary key(s)
			-- delete all matching from the table
			DELETE [dbo].[Client_CallPlan]
			WHERE 
			[CalPlanId] = @CalPlanId
			";

		internal static string ctprClient_CallPlan_SelectAllByClientId = @"
		...
		internal static string ctprClient_CallPlan_SelectAllByClientIdCount = @"
		...
		internal static string ctprClient_CallPlan_DeleteAllByClientId = @"
		...
		internal static string ctprClient_CallPlan_InsertOne = @"
			-- Insert a new row
			-- inserts a new row into the table
			INSERT [dbo].[Client_CallPlan]
			(
			[ClientId]
			,[Day1]
			,[Day2]
			...
			FROM [dbo].[Client_CallPlan]
			WHERE 
			[CalPlanId] = SCOPE_IDENTITY()
			";

		internal static string ctprClient_CallPlan_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[CalPlanId]
		...
		internal static string ctprClient_CallPlan_SelectAllCount = @"
		...
		internal static string ctprClient_CallPlan_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprClient_CallPlan_SelectAllByCriteria = @"
		...
		internal static string ctprClient_CallPlan_SelectAllByCriteriaCount = @"
		...
		internal static string ctprClient_CallPlan_UpdateOne = @"
			-- Update one row based on the primary key(s)
			-- updates a row in the table based on the primary key
			
			UPDATE [dbo].[Client_CallPlan]
			SET
			[ClientId] = @ClientId
			,[Day1] = @Day1
			,[Day2] = @Day2
