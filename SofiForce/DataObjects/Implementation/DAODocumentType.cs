...
{
	public partial class DAODocumentType : zSofiForceConn_BaseData
	{
		...
		public DAODocumentType()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table DocumentType based on the primary key(s)
		///</Summary>
		///<returns>
		///DAODocumentType
		///</returns>
		...
		///</parameters>
		public static DAODocumentType SelectOne(Int32? documentTypeId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprDocumentType_SelectOne;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("DocumentType");
			SqlDataAdapter sqlAdapter = new SqlDataAdapter(command);
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@DocumentTypeId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)documentTypeId?? (object)DBNull.Value));

				staticConnection.Open();
				sqlAdapter.Fill(dt);

				DAODocumentType retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAODocumentType();
					retObj._documentTypeId					 = Convert.IsDBNull(dt.Rows[0]["DocumentTypeId"]) ? (Int32?)null : (Int32?)dt.Rows[0]["DocumentTypeId"];
					retObj._documentTypeCode					 = Convert.IsDBNull(dt.Rows[0]["DocumentTypeCode"]) ? null : (string)dt.Rows[0]["DocumentTypeCode"];
					retObj._documentTypeNameEn					 = Convert.IsDBNull(dt.Rows[0]["DocumentTypeNameEn"]) ? null : (string)dt.Rows[0]["DocumentTypeNameEn"];
					retObj._documentTypeNameAr					 = Convert.IsDBNull(dt.Rows[0]["DocumentTypeNameAr"]) ? null : (string)dt.Rows[0]["DocumentTypeNameAr"];
		...
		///this method allows the object to delete itself from the table DocumentType based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprDocumentType_DeleteOne;
			command.CommandType = CommandType.Text;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@DocumentTypeId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)_documentTypeId?? (object)DBNull.Value));
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table DocumentType
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprDocumentType_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@DocumentTypeId", SqlDbType.Int, 4, ParameterDirection.InputOutput, false, 10, 0, "", DataRowVersion.Proposed, (object)_documentTypeId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@DocumentTypeCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_documentTypeCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@DocumentTypeNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_documentTypeNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@DocumentTypeNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_documentTypeNameAr?? (object)DBNull.Value));
				...
				_documentTypeCode					 = Convert.IsDBNull(command.Parameters["@DocumentTypeCode"].Value) ? null : (string)command.Parameters["@DocumentTypeCode"].Value;
				_documentTypeNameEn					 = Convert.IsDBNull(command.Parameters["@DocumentTypeNameEn"].Value) ? null : (string)command.Parameters["@DocumentTypeNameEn"].Value;
				_documentTypeNameAr					 = Convert.IsDBNull(command.Parameters["@DocumentTypeNameAr"].Value) ? null : (string)command.Parameters["@DocumentTypeNameAr"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table DocumentType
		///</Summary>
		///<returns>
		///IList-DAODocumentType.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static IList<DAODocumentType> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprDocumentType_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAODocumentType> objList = new List<DAODocumentType>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAODocumentType retObj = new DAODocumentType();
						retObj._documentTypeId					 = Convert.IsDBNull(row["DocumentTypeId"]) ? (Int32?)null : (Int32?)row["DocumentTypeId"];
						retObj._documentTypeCode					 = Convert.IsDBNull(row["DocumentTypeCode"]) ? null : (string)row["DocumentTypeCode"];
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprDocumentType_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiDocumentType
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprDocumentType_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				foreach (IDataProjection projection in listProjection)
				{
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						if (string.Compare(projection.Member, "DocumentTypeCode", true) == 0) lst.Add(Convert.IsDBNull(row["DocumentTypeCode"]) ? null : (string)row["DocumentTypeCode"]);
		...
		///This method returns all data rows in the table using criteriaquery api DocumentType
		///</Summary>
		///<returns>
		///IList-DAODocumentType.
		///</returns>
		...
		///</parameters>
		public static IList<DAODocumentType> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprDocumentType_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprDocumentType_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table DocumentType based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprDocumentType_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprDocumentType_SelectOne = @"
		...
		internal static string ctprDocumentType_DeleteOne = @"
			-- Delete a row based on the primary key(s)
			-- delete all matching from the table
			DELETE [dbo].[DocumentType]
			WHERE 
			[DocumentTypeId] = @DocumentTypeId
			";

		internal static string ctprDocumentType_InsertOne = @"
			-- Insert a new row
			...
			,@DocumentTypeNameEn = [DocumentTypeNameEn]
		...
		internal static string ctprDocumentType_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[DocumentTypeId]
		...
		internal static string ctprDocumentType_SelectAllCount = @"
		...
		internal static string ctprDocumentType_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprDocumentType_SelectAllByCriteria = @"
		...
		internal static string ctprDocumentType_SelectAllByCriteriaCount = @"
		...
		internal static string ctprDocumentType_UpdateOne = @"
