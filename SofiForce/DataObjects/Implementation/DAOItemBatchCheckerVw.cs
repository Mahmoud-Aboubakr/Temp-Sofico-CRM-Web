...
{
	public partial class DAOItemBatchCheckerVw : zSofiForceConn_BaseData
	{
		...
		public DAOItemBatchCheckerVw()
		{
		}
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table ItemBatchCheckerVw
		///</Summary>
		///<returns>
		///IList-DAOItemBatchCheckerVw.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static IList<DAOItemBatchCheckerVw> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprItemBatchCheckerVw_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("ItemBatchCheckerVw");
			...
			try
			{
				...
				List<DAOItemBatchCheckerVw> objList = new List<DAOItemBatchCheckerVw>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOItemBatchCheckerVw retObj = new DAOItemBatchCheckerVw();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprItemBatchCheckerVw_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiItemBatchCheckerVw
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItemBatchCheckerVw_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api ItemBatchCheckerVw
		///</Summary>
		///<returns>
		///IList-DAOItemBatchCheckerVw.
		///</returns>
		...
		///</parameters>
		public static IList<DAOItemBatchCheckerVw> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItemBatchCheckerVw_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItemBatchCheckerVw_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprItemBatchCheckerVw_SelectAll = @"
			-- Select All rows
			...
			,[VendorCode]
			,[Quota]
			FROM [dbo].[ItemBatchCheckerVw]
			";

		internal static string ctprItemBatchCheckerVw_SelectAllCount = @"
		...
		internal static string ctprItemBatchCheckerVw_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprItemBatchCheckerVw_SelectAllByCriteria = @"
		...
		internal static string ctprItemBatchCheckerVw_SelectAllByCriteriaCount = @"
