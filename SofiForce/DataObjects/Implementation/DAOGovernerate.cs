...
{
	public partial class DAOGovernerate : zSofiForceConn_BaseData
	{
		...
		public DAOGovernerate()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table Governerate based on the primary key(s)
		///</Summary>
		///<returns>
		///DAOGovernerate
		///</returns>
		...
		///Int32? governerateId
		///</parameters>
		public static DAOGovernerate SelectOne(Int32? governerateId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_SelectOne;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("Governerate");
			SqlDataAdapter sqlAdapter = new SqlDataAdapter(command);
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)governerateId?? (object)DBNull.Value));

				staticConnection.Open();
				sqlAdapter.Fill(dt);

				DAOGovernerate retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOGovernerate();
					...
					retObj._governerateCode					 = Convert.IsDBNull(dt.Rows[0]["GovernerateCode"]) ? null : (string)dt.Rows[0]["GovernerateCode"];
					retObj._governerateNameAr					 = Convert.IsDBNull(dt.Rows[0]["GovernerateNameAr"]) ? null : (string)dt.Rows[0]["GovernerateNameAr"];
					retObj._governerateNameEn					 = Convert.IsDBNull(dt.Rows[0]["GovernerateNameEn"]) ? null : (string)dt.Rows[0]["GovernerateNameEn"];
		...
		///this method allows the object to delete itself from the table Governerate based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_DeleteOne;
			command.CommandType = CommandType.Text;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)_governerateId?? (object)DBNull.Value));
		...
		///This method returns all data rows in the table Governerate based on a foreign key
		///</Summary>
		///<returns>
		///IList-DAOGovernerate.
		///</returns>
		///<parameters>
		///Int32? regionId
		///</parameters>
		public static IList<DAOGovernerate> SelectAllByRegionId(Int32? regionId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_SelectAllByRegionId;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAOGovernerate> objList = new List<DAOGovernerate>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOGovernerate retObj = new DAOGovernerate();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_SelectAllByRegionIdCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method deletes all rows in the table Governerate with a given foreign key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_DeleteAllByRegionId;
			command.CommandType = CommandType.Text;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table Governerate
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateId", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _governerateId));
				...
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_governerateCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_governerateNameAr?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_governerateNameEn?? (object)DBNull.Value));
				...
				_governerateCode					 = Convert.IsDBNull(command.Parameters["@GovernerateCode"].Value) ? null : (string)command.Parameters["@GovernerateCode"].Value;
				_governerateNameAr					 = Convert.IsDBNull(command.Parameters["@GovernerateNameAr"].Value) ? null : (string)command.Parameters["@GovernerateNameAr"].Value;
				_governerateNameEn					 = Convert.IsDBNull(command.Parameters["@GovernerateNameEn"].Value) ? null : (string)command.Parameters["@GovernerateNameEn"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table Governerate
		///</Summary>
		///<returns>
		///IList-DAOGovernerate.
		///</returns>
		...
		///
		///</parameters>
		public static IList<DAOGovernerate> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiGovernerate
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprGovernerate_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api Governerate
		///</Summary>
		///<returns>
		///IList-DAOGovernerate.
		///</returns>
		...
		///</parameters>
		public static IList<DAOGovernerate> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprGovernerate_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprGovernerate_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table Governerate based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprGovernerate_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateId", SqlDbType.Int, 4, ParameterDirection.InputOutput, false, 10, 0, "", DataRowVersion.Proposed, (object)_governerateId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@RegionId", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_regionId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_governerateCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_governerateNameAr?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@GovernerateNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_governerateNameEn?? (object)DBNull.Value));
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprGovernerate_SelectOne = @"
			...
			,[EBy]
			,[EDate]
			FROM [dbo].[Governerate]
			WHERE 
			[GovernerateId] = @GovernerateId
			";

		internal static string ctprGovernerate_DeleteOne = @"
			-- Delete a row based on the primary key(s)
			-- delete all matching from the table
			DELETE [dbo].[Governerate]
			WHERE 
			[GovernerateId] = @GovernerateId
			";

		internal static string ctprGovernerate_SelectAllByRegionId = @"
		...
		internal static string ctprGovernerate_SelectAllByRegionIdCount = @"
		...
		internal static string ctprGovernerate_DeleteAllByRegionId = @"
		...
		internal static string ctprGovernerate_InsertOne = @"
			-- Insert a new row
			-- inserts a new row into the table
			INSERT [dbo].[Governerate]
			(
			[RegionId]
			,[GovernerateCode]
			,[GovernerateNameAr]
			...
			@GovernerateId = [GovernerateId]
			,@RegionId = [RegionId]
			,@GovernerateCode = [GovernerateCode]
			...
			FROM [dbo].[Governerate]
			WHERE 
			[GovernerateId] = SCOPE_IDENTITY()
			";

		internal static string ctprGovernerate_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[GovernerateId]
		...
		internal static string ctprGovernerate_SelectAllCount = @"
		...
		internal static string ctprGovernerate_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprGovernerate_SelectAllByCriteria = @"
		...
		internal static string ctprGovernerate_SelectAllByCriteriaCount = @"
		...
		internal static string ctprGovernerate_UpdateOne = @"
			-- Update one row based on the primary key(s)
			-- updates a row in the table based on the primary key
			
			UPDATE [dbo].[Governerate]
			SET
			[RegionId] = @RegionId
			,[GovernerateCode] = @GovernerateCode
			,[GovernerateNameAr] = @GovernerateNameAr
