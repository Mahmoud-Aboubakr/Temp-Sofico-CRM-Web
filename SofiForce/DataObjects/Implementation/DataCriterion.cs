...
namespace SofiForce.DataObjects
{
	...
	public class DataCriterionStartWith : DataCriterion, IDataCriterion
	{
		public string ToSql()
		{
			string quote = "";
			...
			return "[" + PropertyName + "] LIKE '" + propValue+quote + "'";
		}
	}
	public class DataCriterionEndWith : DataCriterion, IDataCriterion
	{
		public string ToSql()
		{
			string quote = "";
			...
			return "[" + PropertyName + "] LIKE '" + quote+propValue + "'";
		}
	}
