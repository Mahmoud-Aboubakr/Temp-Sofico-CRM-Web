...
{
	public partial class DAOBusinessUnit : zSofiForceConn_BaseData
	{
		...
		public DAOBusinessUnit()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table BusinessUnit based on the primary key(s)
		///</Summary>
		///<returns>
		///DAOBusinessUnit
		///</returns>
		...
		///</parameters>
		public static DAOBusinessUnit SelectOne(Int32? businessUnitId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_SelectOne;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("BusinessUnit");
			SqlDataAdapter sqlAdapter = new SqlDataAdapter(command);
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)businessUnitId?? (object)DBNull.Value));

				staticConnection.Open();
				sqlAdapter.Fill(dt);

				DAOBusinessUnit retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOBusinessUnit();
					...
					retObj._businessUnitCode					 = Convert.IsDBNull(dt.Rows[0]["BusinessUnitCode"]) ? null : (string)dt.Rows[0]["BusinessUnitCode"];
					retObj._businessUnitNameEn					 = Convert.IsDBNull(dt.Rows[0]["BusinessUnitNameEn"]) ? null : (string)dt.Rows[0]["BusinessUnitNameEn"];
					retObj._businessUnitNameAr					 = Convert.IsDBNull(dt.Rows[0]["BusinessUnitNameAr"]) ? null : (string)dt.Rows[0]["BusinessUnitNameAr"];
		...
		///this method allows the object to delete itself from the table BusinessUnit based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_DeleteOne;
			command.CommandType = CommandType.Text;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)_businessUnitId?? (object)DBNull.Value));
		...
		///This method returns all data rows in the table BusinessUnit based on a foreign key
		///</Summary>
		///<returns>
		///IList-DAOBusinessUnit.
		///</returns>
		///<parameters>
		///Int32? branchId
		///</parameters>
		public static IList<DAOBusinessUnit> SelectAllByBranchId(Int32? branchId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_SelectAllByBranchId;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAOBusinessUnit> objList = new List<DAOBusinessUnit>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOBusinessUnit retObj = new DAOBusinessUnit();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_SelectAllByBranchIdCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method deletes all rows in the table BusinessUnit with a given foreign key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_DeleteAllByBranchId;
			command.CommandType = CommandType.Text;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table BusinessUnit
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitId", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _businessUnitId));
				...
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_businessUnitCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_businessUnitNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_businessUnitNameAr?? (object)DBNull.Value));
				...
				_businessUnitCode					 = Convert.IsDBNull(command.Parameters["@BusinessUnitCode"].Value) ? null : (string)command.Parameters["@BusinessUnitCode"].Value;
				_businessUnitNameEn					 = Convert.IsDBNull(command.Parameters["@BusinessUnitNameEn"].Value) ? null : (string)command.Parameters["@BusinessUnitNameEn"].Value;
				_businessUnitNameAr					 = Convert.IsDBNull(command.Parameters["@BusinessUnitNameAr"].Value) ? null : (string)command.Parameters["@BusinessUnitNameAr"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table BusinessUnit
		///</Summary>
		///<returns>
		///IList-DAOBusinessUnit.
		///</returns>
		...
		///
		///</parameters>
		public static IList<DAOBusinessUnit> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiBusinessUnit
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprBusinessUnit_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api BusinessUnit
		///</Summary>
		///<returns>
		///IList-DAOBusinessUnit.
		///</returns>
		...
		///</parameters>
		public static IList<DAOBusinessUnit> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprBusinessUnit_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprBusinessUnit_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table BusinessUnit based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprBusinessUnit_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitId", SqlDbType.Int, 4, ParameterDirection.InputOutput, false, 10, 0, "", DataRowVersion.Proposed, (object)_businessUnitId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@BranchId", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_branchId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_businessUnitCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_businessUnitNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@BusinessUnitNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_businessUnitNameAr?? (object)DBNull.Value));
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprBusinessUnit_SelectOne = @"
		...
		internal static string ctprBusinessUnit_DeleteOne = @"
		...
		internal static string ctprBusinessUnit_SelectAllByBranchId = @"
		...
		internal static string ctprBusinessUnit_SelectAllByBranchIdCount = @"
		...
		internal static string ctprBusinessUnit_DeleteAllByBranchId = @"
		...
		internal static string ctprBusinessUnit_InsertOne = @"
			-- Insert a new row
			-- inserts a new row into the table
			INSERT [dbo].[BusinessUnit]
			(
			[BranchId]
			,[BusinessUnitCode]
			,[BusinessUnitNameEn]
			...
			,@BusinessUnitNameEn = [BusinessUnitNameEn]
			,@BusinessUnitNameAr = [BusinessUnitNameAr]
			,@Icon = [Icon]
			,@Color = [Color]
			...
			FROM [dbo].[BusinessUnit]
			WHERE 
			[BusinessUnitId] = SCOPE_IDENTITY()
			";

		internal static string ctprBusinessUnit_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[BusinessUnitId]
		...
		internal static string ctprBusinessUnit_SelectAllCount = @"
		...
		internal static string ctprBusinessUnit_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprBusinessUnit_SelectAllByCriteria = @"
		...
		internal static string ctprBusinessUnit_SelectAllByCriteriaCount = @"
		...
		internal static string ctprBusinessUnit_UpdateOne = @"
