...
{
	public partial class zSofiForceConn_BaseData : IDisposable
	{
		#region members
		protected zSofiForceConn_TxConnectionProvider _connectionProvider;
		static string _staticConnectionString;
		bool _isDisposed = false;
		#endregion

		#region initialisation
		public zSofiForceConn_BaseData()
		{
			Init();
		}
		...
		public virtual zSofiForceConn_TxConnectionProvider ConnectionProvider
		{
			set
			{
				if(value == null)
