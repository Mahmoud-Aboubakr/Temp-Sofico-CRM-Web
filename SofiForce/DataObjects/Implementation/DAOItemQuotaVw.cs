...
{
	public partial class DAOItemQuotaVw : zSofiForceConn_BaseData
	{
		...
		public DAOItemQuotaVw()
		{
		}
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table Item_QuotaVw
		///</Summary>
		///<returns>
		///IList-DAOItemQuotaVw.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static IList<DAOItemQuotaVw> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprItem_QuotaVw_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("Item_QuotaVw");
			...
			try
			{
				...
				List<DAOItemQuotaVw> objList = new List<DAOItemQuotaVw>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOItemQuotaVw retObj = new DAOItemQuotaVw();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprItem_QuotaVw_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiItem_QuotaVw
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItem_QuotaVw_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api Item_QuotaVw
		///</Summary>
		///<returns>
		///IList-DAOItemQuotaVw.
		///</returns>
		...
		///</parameters>
		public static IList<DAOItemQuotaVw> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItem_QuotaVw_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItem_QuotaVw_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprItem_QuotaVw_SelectAll = @"
			-- Select All rows
			...
			,[IsNewStocked]
			,[IsTaxable]
			FROM [dbo].[Item_QuotaVw]
			";

		internal static string ctprItem_QuotaVw_SelectAllCount = @"
		...
		internal static string ctprItem_QuotaVw_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprItem_QuotaVw_SelectAllByCriteria = @"
		...
		internal static string ctprItem_QuotaVw_SelectAllByCriteriaCount = @"
