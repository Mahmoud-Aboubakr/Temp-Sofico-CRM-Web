...
{
	public partial class DAOItemAvailablityVw : zSofiForceConn_BaseData
	{
		...
		public DAOItemAvailablityVw()
		{
		}
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table ItemAvailablityVw
		///</Summary>
		///<returns>
		///IList-DAOItemAvailablityVw.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static IList<DAOItemAvailablityVw> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprItemAvailablityVw_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("ItemAvailablityVw");
			...
			try
			{
				...
				List<DAOItemAvailablityVw> objList = new List<DAOItemAvailablityVw>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOItemAvailablityVw retObj = new DAOItemAvailablityVw();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprItemAvailablityVw_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiItemAvailablityVw
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItemAvailablityVw_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api ItemAvailablityVw
		///</Summary>
		///<returns>
		///IList-DAOItemAvailablityVw.
		///</returns>
		...
		///</parameters>
		public static IList<DAOItemAvailablityVw> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItemAvailablityVw_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprItemAvailablityVw_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprItemAvailablityVw_SelectAll = @"
			-- Select All rows
			...
			,[Quantity]
			,[Quota]
			FROM [dbo].[ItemAvailablityVw]
			";

		internal static string ctprItemAvailablityVw_SelectAllCount = @"
		...
		internal static string ctprItemAvailablityVw_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprItemAvailablityVw_SelectAllByCriteria = @"
		...
		internal static string ctprItemAvailablityVw_SelectAllByCriteriaCount = @"
