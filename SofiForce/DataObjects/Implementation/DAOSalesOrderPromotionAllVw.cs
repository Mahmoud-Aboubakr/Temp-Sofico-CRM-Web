...
{
	public partial class DAOSalesOrderPromotionAllVw : zSofiForceConn_BaseData
	{
		...
		public DAOSalesOrderPromotionAllVw()
		{
		}
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table SalesOrder_PromotionAllVw
		///</Summary>
		///<returns>
		///IList-DAOSalesOrderPromotionAllVw.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static IList<DAOSalesOrderPromotionAllVw> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprSalesOrder_PromotionAllVw_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("SalesOrder_PromotionAllVw");
			...
			try
			{
				...
				List<DAOSalesOrderPromotionAllVw> objList = new List<DAOSalesOrderPromotionAllVw>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOSalesOrderPromotionAllVw retObj = new DAOSalesOrderPromotionAllVw();
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprSalesOrder_PromotionAllVw_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiSalesOrder_PromotionAllVw
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprSalesOrder_PromotionAllVw_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api SalesOrder_PromotionAllVw
		///</Summary>
		///<returns>
		///IList-DAOSalesOrderPromotionAllVw.
		///</returns>
		...
		///</parameters>
		public static IList<DAOSalesOrderPromotionAllVw> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprSalesOrder_PromotionAllVw_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprSalesOrder_PromotionAllVw_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprSalesOrder_PromotionAllVw_SelectAll = @"
			-- Select All rows
			...
			,[ClientGroupNameEn]
			,[ClientGroupNameAr]
			FROM [dbo].[SalesOrder_PromotionAllVw]
			";

		internal static string ctprSalesOrder_PromotionAllVw_SelectAllCount = @"
		...
		internal static string ctprSalesOrder_PromotionAllVw_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprSalesOrder_PromotionAllVw_SelectAllByCriteria = @"
		...
		internal static string ctprSalesOrder_PromotionAllVw_SelectAllByCriteriaCount = @"
