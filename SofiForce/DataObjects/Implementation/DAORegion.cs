...
{
	public partial class DAORegion : zSofiForceConn_BaseData
	{
		...
		public static DAORegion SelectOne(Int32? regionId)
		{
			...
			try
			{
				...
				if(dt.Rows.Count > 0)
				{
					...
					retObj._regionNameAr					 = Convert.IsDBNull(dt.Rows[0]["RegionNameAr"]) ? null : (string)dt.Rows[0]["RegionNameAr"];
					retObj._regionNameEn					 = Convert.IsDBNull(dt.Rows[0]["RegionNameEn"]) ? null : (string)dt.Rows[0]["RegionNameEn"];
					retObj._regionCode					 = Convert.IsDBNull(dt.Rows[0]["RegionCode"]) ? null : (string)dt.Rows[0]["RegionCode"];
		...
		public virtual void Insert()
		{
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@RegionId", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _regionId));
				command.Parameters.Add(CtSqlParameter.Get("@RegionNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_regionNameAr?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@RegionNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_regionNameEn?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@RegionCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_regionCode?? (object)DBNull.Value));
				...
				_regionNameAr					 = Convert.IsDBNull(command.Parameters["@RegionNameAr"].Value) ? null : (string)command.Parameters["@RegionNameAr"].Value;
				_regionNameEn					 = Convert.IsDBNull(command.Parameters["@RegionNameEn"].Value) ? null : (string)command.Parameters["@RegionNameEn"].Value;
				_regionCode					 = Convert.IsDBNull(command.Parameters["@RegionCode"].Value) ? null : (string)command.Parameters["@RegionCode"].Value;
			...
			try
			{
				...
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						...
						retObj._regionNameAr					 = Convert.IsDBNull(row["RegionNameAr"]) ? null : (string)row["RegionNameAr"];
						retObj._regionNameEn					 = Convert.IsDBNull(row["RegionNameEn"]) ? null : (string)row["RegionNameEn"];
						retObj._regionCode					 = Convert.IsDBNull(row["RegionCode"]) ? null : (string)row["RegionCode"];
			...
			try
			{
				...
				foreach (IDataProjection projection in listProjection)
				{
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						if (string.Compare(projection.Member, "RegionNameAr", true) == 0) lst.Add(Convert.IsDBNull(row["RegionNameAr"]) ? null : (string)row["RegionNameAr"]);
						if (string.Compare(projection.Member, "RegionNameEn", true) == 0) lst.Add(Convert.IsDBNull(row["RegionNameEn"]) ? null : (string)row["RegionNameEn"]);
						if (string.Compare(projection.Member, "RegionCode", true) == 0) lst.Add(Convert.IsDBNull(row["RegionCode"]) ? null : (string)row["RegionCode"]);
