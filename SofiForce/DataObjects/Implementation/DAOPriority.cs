...
{
	public partial class DAOPriority : zSofiForceConn_BaseData
	{
		...
		///This method returns one row from the table Priority based on the primary key(s)
		///</Summary>
		///<returns>
		///DAOPriority
		///</returns>
		...
		///Int32? priorityId
		///</parameters>
		public static DAOPriority SelectOne(Int32? priorityId)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprPriority_SelectOne;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("Priority");
			SqlDataAdapter sqlAdapter = new SqlDataAdapter(command);
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@PriorityId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)priorityId?? (object)DBNull.Value));

				staticConnection.Open();
				sqlAdapter.Fill(dt);

				DAOPriority retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOPriority();
					retObj._priorityId					 = Convert.IsDBNull(dt.Rows[0]["PriorityId"]) ? (Int32?)null : (Int32?)dt.Rows[0]["PriorityId"];
					retObj._priorityCode					 = Convert.IsDBNull(dt.Rows[0]["PriorityCode"]) ? null : (string)dt.Rows[0]["PriorityCode"];
					retObj._priorityNameAr					 = Convert.IsDBNull(dt.Rows[0]["PriorityNameAr"]) ? null : (string)dt.Rows[0]["PriorityNameAr"];
					retObj._priorityNameEn					 = Convert.IsDBNull(dt.Rows[0]["PriorityNameEn"]) ? null : (string)dt.Rows[0]["PriorityNameEn"];
		...
		///this method allows the object to delete itself from the table Priority based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprPriority_DeleteOne;
			command.CommandType = CommandType.Text;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@PriorityId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)_priorityId?? (object)DBNull.Value));
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table Priority
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprPriority_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				command.Parameters.Add(CtSqlParameter.Get("@PriorityId", SqlDbType.Int, 4, ParameterDirection.InputOutput, false, 10, 0, "", DataRowVersion.Proposed, (object)_priorityId?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@PriorityCode", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_priorityCode?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@PriorityNameAr", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_priorityNameAr?? (object)DBNull.Value));
				command.Parameters.Add(CtSqlParameter.Get("@PriorityNameEn", SqlDbType.NVarChar, 50, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, (object)_priorityNameEn?? (object)DBNull.Value));
				...
				_priorityCode					 = Convert.IsDBNull(command.Parameters["@PriorityCode"].Value) ? null : (string)command.Parameters["@PriorityCode"].Value;
				_priorityNameAr					 = Convert.IsDBNull(command.Parameters["@PriorityNameAr"].Value) ? null : (string)command.Parameters["@PriorityNameAr"].Value;
				_priorityNameEn					 = Convert.IsDBNull(command.Parameters["@PriorityNameEn"].Value) ? null : (string)command.Parameters["@PriorityNameEn"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table Priority
		///</Summary>
		///<returns>
		///IList-DAOPriority.
		///</returns>
		...
		///
		///</parameters>
		public static IList<DAOPriority> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprPriority_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAOPriority> objList = new List<DAOPriority>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOPriority retObj = new DAOPriority();
						retObj._priorityId					 = Convert.IsDBNull(row["PriorityId"]) ? (Int32?)null : (Int32?)row["PriorityId"];
						retObj._priorityCode					 = Convert.IsDBNull(row["PriorityCode"]) ? null : (string)row["PriorityCode"];
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprPriority_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiPriority
		///</Summary>
		///<returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprPriority_SelectAllByCriteriaProjection, listProjection, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				foreach (IDataProjection projection in listProjection)
				{
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						if (string.Compare(projection.Member, "PriorityCode", true) == 0) lst.Add(Convert.IsDBNull(row["PriorityCode"]) ? null : (string)row["PriorityCode"]);
		...
		///This method returns all data rows in the table using criteriaquery api Priority
		///</Summary>
		///<returns>
		///IList-DAOPriority.
		///</returns>
		...
		///</parameters>
		public static IList<DAOPriority> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprPriority_SelectAllByCriteria, null, listCriterion, listOrder, dataSkip, dataTake);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = GetSelectionCriteria(InlineProcs.ctprPriority_SelectAllByCriteriaCount, null, listCriterion, null);
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table Priority based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprPriority_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
...
namespace SofiForce.DataObjects
{
	...
	{
		internal static string ctprPriority_SelectOne = @"
		...
		internal static string ctprPriority_DeleteOne = @"
		...
		internal static string ctprPriority_InsertOne = @"
			-- Insert a new row
			...
			,@PriorityNameAr = [PriorityNameAr]
			,@PriorityNameEn = [PriorityNameEn]
			,@Icon = [Icon]
			,@Color = [Color]
		...
		internal static string ctprPriority_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[PriorityId]
		...
		internal static string ctprPriority_SelectAllCount = @"
		...
		internal static string ctprPriority_SelectAllByCriteriaProjection = @"
		...
		internal static string ctprPriority_SelectAllByCriteria = @"
		...
		internal static string ctprPriority_SelectAllByCriteriaCount = @"
		...
		internal static string ctprPriority_UpdateOne = @"
