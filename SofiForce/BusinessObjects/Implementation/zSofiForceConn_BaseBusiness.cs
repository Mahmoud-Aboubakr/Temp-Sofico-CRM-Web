...
{
	public partial class zSofiForceConn_BaseBusiness : IDisposable
	{
		#region members
		bool _isDisposed = false;
		protected zSofiForceConn_TxConnectionProvider _txConnectionProvider;
		protected List<zSofiForceConn_BaseBusiness> _listBusObjects = new List<zSofiForceConn_BaseBusiness>();
		int _nestLevel;
		#endregion

		#region initialization
		public zSofiForceConn_BaseBusiness()
		{
			Init();
		}
		...
		protected virtual void RegisterDataObject(zSofiForceConn_BaseData dataObject)
		{
				if(_txConnectionProvider == null)
					_txConnectionProvider = new zSofiForceConn_TxConnectionProvider();
		
				if(dataObject != null)
					dataObject.ConnectionProvider = _txConnectionProvider;
		}

		protected virtual void RegisterBusinessObject(zSofiForceConn_BaseBusiness busObject)
		{
				if(_txConnectionProvider == null)
					_txConnectionProvider = new zSofiForceConn_TxConnectionProvider();
		...
		public virtual void BeginTransaction(string trans)
		{
			if(_nestLevel == 0)
			{
				...
				if(_listBusObjects != null)
					foreach (zSofiForceConn_BaseBusiness busObj in _listBusObjects)
		...
		public zSofiForceConn_TxConnectionProvider ConnectionProvider
		{
			get
			{
