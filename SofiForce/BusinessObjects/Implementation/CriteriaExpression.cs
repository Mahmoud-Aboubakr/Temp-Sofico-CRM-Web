...
namespace SofiForce.BusinessObjects
{
	...
	public class Expression
	{
		...
		public static ICriterion StartWith(string propertyName, params object[] value)
		{
			return (ICriterion)new StartWithCriterion() { PropertyName = propertyName, PropertyValue = value[0], Formatter = value.Length > 1 ? (Func<object, string>)value[1] : null };
		}
		public static ICriterion EndWith(string propertyName, params object[] value)
		{
			return (ICriterion)new EndWithCriterion() { PropertyName = propertyName, PropertyValue = value[0], Formatter = value.Length > 1 ? (Func<object, string>)value[1] : null };
		}
