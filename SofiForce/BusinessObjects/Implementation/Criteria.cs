...
** This class was generated on 10/31/2022 11:40:05 AM
**************************************************************/
...
namespace SofiForce.BusinessObjects
{
	...
	public class StartWithCriterion : Criterion
	{
		public override object Clone()
		{
			return new StartWithCriterion() { PropertyName = this.PropertyName, PropertyValue = this.PropertyValue, Formatter = this.Formatter };
		}

		public override IDataCriterion DataCriterion()
		{
			return (IDataCriterion)new DataCriterionStartWith() { PropertyName = this.PropertyName, PropertyValue = this.PropertyValue, Formatter = this.Formatter };
		}
	}

	public class EndWithCriterion : Criterion
	{
		public override object Clone()
		{
			return new EndWithCriterion() { PropertyName = this.PropertyName, PropertyValue = this.PropertyValue, Formatter = this.Formatter };
		}

		public override IDataCriterion DataCriterion()
		{
			return (IDataCriterion)new DataCriterionEndWith() { PropertyName = this.PropertyName, PropertyValue = this.PropertyValue, Formatter = this.Formatter };
		}
	}
