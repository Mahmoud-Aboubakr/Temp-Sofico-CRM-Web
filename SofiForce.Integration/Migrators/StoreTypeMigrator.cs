...
{
    public class StoreTypeMigrator
    {
        ...
        public static string SP_LocationTypes = @"
                    SELECT A.ENUMITEMVALUE       as Code, 
                          A.ENUMITEMLABEL        AS Name 
                    FROM [SOF-SRV-DB12].[SofDynAXLive].dbo.SRSANALYSISENUMS A WHERE A.enumname ='SiteType'
        ";

        public StoreTypeMigrator( IConfiguration configuration)
        {
        ...
        public MigrationDTO Migrate()
        {
            ...
            try
            {
                ...
                _TempCommand.CommandText = "truncate table LocationTypes";
                _TempCommand.ExecuteNonQuery();

                _AXCommand.CommandType = CommandType.Text;
                _AXCommand.CommandText = SP_LocationTypes;
                ...
                // Migrrate Data
                _SqlBulkCopy.DestinationTableName = "LocationTypes";

                _SqlBulkCopy.ColumnMappings.Add("Code", "Code");
                ...
                _TempCommand.CommandText = "Migrate_LocationTypes";
                _TempCommand.ExecuteNonQuery();
