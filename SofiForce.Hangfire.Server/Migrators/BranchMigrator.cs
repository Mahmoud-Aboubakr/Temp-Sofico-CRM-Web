...
namespace SofiForce.Hangfire.Server
{
    public class BranchMigrator
    {
        ...
        //done
        public static string SP_Branchs = @"select s.SITEID as BranchCode, 
                ltrim(rtrim((replace(s.NAME,',',' '))))  as BranchName
				
                from [SOF-SRV-DB12].SofDynAXLive.dbo.InventSite s
				
                where DATAAREAID='sfc'";

        public BranchMigrator( IConfiguration configuration)
        {
        ...
        public  void Migrate()
        {
            ...
            try
            {
                ...
                _TempCommand.CommandText = "truncate table Branchs";
                _TempCommand.ExecuteNonQuery();

                _AXCommand.CommandType = CommandType.Text;
                _AXCommand.CommandText = SP_Branchs;
                ...
                // Migrrate Data
                _SqlBulkCopy.DestinationTableName = "Branchs";
                ...
                _TempCommand.CommandText = "Migrate_Branchs";
                _TempCommand.ExecuteNonQuery();
