namespace SofiForce.Worker.Shared
{
    ...
    {
        public static string SYSTEM_ERROR = "System Error Please try Again";
        ...
        public static string INVALID_BATCH_QTY = "No quantity available for Product {0} , please try again";
        public static string INVALID_BOUNS_QTY = "No bouns quantity available for Product {0} , please try again";
