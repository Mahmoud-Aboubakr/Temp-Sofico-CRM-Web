...
namespace SofiForce.Worker
{
    public class Worker5 : BackgroundService
    {
        ...
        public Worker5(ILogger<Worker5> logger, IConfiguration configuration, IOrderService orderService)
        {
            _logger = logger;
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    var worker = new Criteria<BOServiceWorker>()
                        .Add(Expression.Eq(nameof(BOServiceWorker.ServiceWorkerCode), "5"))
