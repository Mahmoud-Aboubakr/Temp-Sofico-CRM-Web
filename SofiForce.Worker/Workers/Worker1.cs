...
namespace SofiForce.Worker
{
    public class Worker1 : BackgroundService
    {
        ...
        public Worker1(ILogger<Worker1> logger, IConfiguration configuration, IOrderService orderService)
        {
            _logger = logger;
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    var worker = new Criteria<BOServiceWorker>()
                        .Add(Expression.Eq(nameof(BOServiceWorker.ServiceWorkerCode), "1"))
