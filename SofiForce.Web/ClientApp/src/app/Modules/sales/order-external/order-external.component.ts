...
@Component({
  ...
  templateUrl: './order-external.component.html',
  styleUrls: ['./order-external.component.scss']
})
export class OrderExternalComponent implements OnInit {
  ...
  async onSelectionChange(event) {
    this.selected = event;
    await this.refreshMenu(this.selected);
  }
  async refreshMenu(event) {
