...
namespace SofiForce.Web.Controllers.CRM
{
    ...
    public class ReturnOrderController : BaseController
    {
        ...
        public ReturnOrderController(
            IHttpContextAccessor contextAccessor, IWebHostEnvironment env, IConfiguration configuration, IMapper mapper, IOrderLoggerService orderLoggerService, IPromotionReturnCalculator promotionCalculator) : base(contextAccessor)
        {
            _env = env;
